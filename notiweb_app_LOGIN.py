...
# --- FORZAR MENU VISIBLE Y DESOCULTAR SI ESTABA EN << ---
html("""
<script>
try {
  window.parent.localStorage.setItem('st.sidebar.collapsed', 'false');
...
def login_final():
    ...
    <div class="login-card">
        <div style="text-align:center; margin-bottom:16px;">
            <img src="data:image/png;base64,{LOGO_B64}" style="width:80px; height:80px; border-radius:50%; background:white; padding:6px; border:3px solid #3b82f6;">
        </div>
...
with st.sidebar:
    st.markdown(f'''
    <div style="text-align:center; background:white; padding:18px 12px; border-radius:16px; border:1px solid #e2e8f0; margin-bottom:16px;">
        <img src="data:image/png;base64,{LOGO_B64}" style="width:95px; height:95px; border-radius:50%; background:white; padding:5px; border:3px solid #0e5c8a; object-fit:contain;">
        <div style="font-weight:800; color:#0f172a; font-size:14px; margin-top:8px;">UE 405</div>
        <div style="font-size:11px; color:#64748b;">{usuario_actual}</div>
    </div>
    ''', unsafe_allow_html=True)
...
st.markdown(f'''
<div style="display:flex; align-items:center; background:white; padding:12px 18px; border-radius:14px; margin-bottom:16px; border:1px solid #e2e8f0;">
